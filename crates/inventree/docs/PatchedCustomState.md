...
**key** | Option<**i32**> | Numerical value that will be saved in the models database | [optional]
...
**logical_key** | Option<**i32**> | State logical key that is equal to this custom state in business logic | [optional]
