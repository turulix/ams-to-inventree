...
**category_name** | Option<**String**> |  | [optional][readonly]
...
**full_name** | Option<**String**> | Format a 'full name' for this Part based on the format PART_NAME_FORMAT defined in InvenTree settings. | [optional][readonly]
...
**name** | Option<**String**> | Part name | [optional]
...
**starred** | Option<**bool**> | Return \"true\" if the part is starred by the current user. | [optional][readonly]
**thumbnail** | Option<**String**> |  | [optional][readonly]
