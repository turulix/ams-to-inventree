...
pub struct PaginatedDataImportSessionList {
    #[serde(rename = "count")]
    pub count: i32,
    ...
    pub results: Vec<models::DataImportSession>,
}

impl PaginatedDataImportSessionList {
    pub fn new(count: i32, results: Vec<models::DataImportSession>) -> PaginatedDataImportSessionList {
