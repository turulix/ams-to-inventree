...
/// PatchedMeUser : API serializer specifically for the 'me' endpoint.
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct PatchedMeUser {
    ...
    pub profile: Option<Box<models::UserProfile>>,
}

impl PatchedMeUser {
    /// API serializer specifically for the 'me' endpoint.
    pub fn new() -> PatchedMeUser {
        PatchedMeUser {
            pk: None,
            username: None,
            first_name: None,
