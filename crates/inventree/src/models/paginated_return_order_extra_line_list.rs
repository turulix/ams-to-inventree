...
pub struct PaginatedReturnOrderExtraLineList {
    #[serde(rename = "count")]
    pub count: i32,
    ...
    pub results: Vec<models::ReturnOrderExtraLine>,
}

impl PaginatedReturnOrderExtraLineList {
    pub fn new(count: i32, results: Vec<models::ReturnOrderExtraLine>) -> PaginatedReturnOrderExtraLineList {
