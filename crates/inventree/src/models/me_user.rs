...
/// MeUser : API serializer specifically for the 'me' endpoint.
...
impl MeUser {
    ...
    pub fn new(pk: i32, username: String, first_name: String, last_name: String, email: String, groups: Vec<models::Group>, profile: models::UserProfile) -> MeUser {
        MeUser {
            pk,
            username,
            first_name,
