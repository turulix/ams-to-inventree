...
pub struct PaginatedStockItemTestResultList {
    #[serde(rename = "count")]
    pub count: i32,
    ...
    pub results: Vec<models::StockItemTestResult>,
}

impl PaginatedStockItemTestResultList {
    pub fn new(count: i32, results: Vec<models::StockItemTestResult>) -> PaginatedStockItemTestResultList {
