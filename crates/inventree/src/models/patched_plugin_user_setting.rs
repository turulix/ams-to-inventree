...
/// PatchedPluginUserSetting : Serializer for the PluginUserSetting model.
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct PatchedPluginUserSetting {
...
impl PatchedPluginUserSetting {
    /// Serializer for the PluginUserSetting model.
    pub fn new() -> PatchedPluginUserSetting {
