...
pub struct PaginatedPartInternalPriceList {
    #[serde(rename = "count")]
    pub count: i32,
    ...
    pub results: Vec<models::PartInternalPrice>,
}

impl PaginatedPartInternalPriceList {
    pub fn new(count: i32, results: Vec<models::PartInternalPrice>) -> PaginatedPartInternalPriceList {
