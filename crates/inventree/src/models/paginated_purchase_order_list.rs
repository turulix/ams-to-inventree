...
pub struct PaginatedPurchaseOrderList {
    #[serde(rename = "count")]
    pub count: i32,
    ...
    pub results: Vec<models::PurchaseOrder>,
}

impl PaginatedPurchaseOrderList {
    pub fn new(count: i32, results: Vec<models::PurchaseOrder>) -> PaginatedPurchaseOrderList {
