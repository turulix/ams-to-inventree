...
pub struct PaginatedPartTestTemplateList {
    #[serde(rename = "count")]
    pub count: i32,
    ...
    pub results: Vec<models::PartTestTemplate>,
}

impl PaginatedPartTestTemplateList {
    pub fn new(count: i32, results: Vec<models::PartTestTemplate>) -> PaginatedPartTestTemplateList {
