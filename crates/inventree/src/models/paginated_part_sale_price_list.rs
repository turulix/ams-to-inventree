...
pub struct PaginatedPartSalePriceList {
    #[serde(rename = "count")]
    pub count: i32,
    ...
    pub results: Vec<models::PartSalePrice>,
}

impl PaginatedPartSalePriceList {
    pub fn new(count: i32, results: Vec<models::PartSalePrice>) -> PaginatedPartSalePriceList {
