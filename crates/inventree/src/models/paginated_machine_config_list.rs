...
pub struct PaginatedMachineConfigList {
    #[serde(rename = "count")]
    pub count: i32,
    ...
    pub results: Vec<models::MachineConfig>,
}

impl PaginatedMachineConfigList {
    pub fn new(count: i32, results: Vec<models::MachineConfig>) -> PaginatedMachineConfigList {
