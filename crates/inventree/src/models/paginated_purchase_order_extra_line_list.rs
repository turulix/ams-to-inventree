...
pub struct PaginatedPurchaseOrderExtraLineList {
    #[serde(rename = "count")]
    pub count: i32,
    ...
    pub results: Vec<models::PurchaseOrderExtraLine>,
}

impl PaginatedPurchaseOrderExtraLineList {
    pub fn new(count: i32, results: Vec<models::PurchaseOrderExtraLine>) -> PaginatedPurchaseOrderExtraLineList {
