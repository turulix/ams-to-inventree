...
pub struct PaginatedScheduledTaskList {
    #[serde(rename = "count")]
    pub count: i32,
    ...
    pub results: Vec<models::ScheduledTask>,
}

impl PaginatedScheduledTaskList {
    pub fn new(count: i32, results: Vec<models::ScheduledTask>) -> PaginatedScheduledTaskList {
