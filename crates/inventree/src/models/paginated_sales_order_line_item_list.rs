...
pub struct PaginatedSalesOrderLineItemList {
    #[serde(rename = "count")]
    pub count: i32,
    ...
    pub results: Vec<models::SalesOrderLineItem>,
}

impl PaginatedSalesOrderLineItemList {
    pub fn new(count: i32, results: Vec<models::SalesOrderLineItem>) -> PaginatedSalesOrderLineItemList {
