...
pub struct PaginatedSalesOrderAllocationList {
    #[serde(rename = "count")]
    pub count: i32,
    ...
    pub results: Vec<models::SalesOrderAllocation>,
}

impl PaginatedSalesOrderAllocationList {
    pub fn new(count: i32, results: Vec<models::SalesOrderAllocation>) -> PaginatedSalesOrderAllocationList {
