...
pub struct PaginatedCategoryParameterTemplateList {
    #[serde(rename = "count")]
    pub count: i32,
    ...
    pub results: Vec<models::CategoryParameterTemplate>,
}

impl PaginatedCategoryParameterTemplateList {
    pub fn new(count: i32, results: Vec<models::CategoryParameterTemplate>) -> PaginatedCategoryParameterTemplateList {
