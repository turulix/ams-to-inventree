...
pub struct PaginatedPurchaseOrderLineItemList {
    #[serde(rename = "count")]
    pub count: i32,
    ...
    pub results: Vec<models::PurchaseOrderLineItem>,
}

impl PaginatedPurchaseOrderLineItemList {
    pub fn new(count: i32, results: Vec<models::PurchaseOrderLineItem>) -> PaginatedPurchaseOrderLineItemList {
