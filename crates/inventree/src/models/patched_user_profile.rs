...
/// PatchedUserProfile : Serializer for the UserProfile model.
...
pub struct PatchedUserProfile {
    ...
    #[serde(rename = "widgets", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    ...
    #[serde(rename = "primary_group", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
