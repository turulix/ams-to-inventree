...
pub struct SelectionList {
    ...
    #[serde(rename = "source_plugin", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
...
impl SelectionList {
    ...
    pub fn new(pk: i32, name: String, default: models::SelectionEntry, created: String, last_updated: String, entry_count: i32) -> SelectionList {
        SelectionList {
            pk,
            name,
            description: None,
