...
pub struct PaginatedStockItemList {
    #[serde(rename = "count")]
    pub count: i32,
    ...
    pub results: Vec<models::StockItem>,
}

impl PaginatedStockItemList {
    pub fn new(count: i32, results: Vec<models::StockItem>) -> PaginatedStockItemList {
