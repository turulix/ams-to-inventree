...
pub struct PaginatedBuildLineList {
    #[serde(rename = "count")]
    pub count: i32,
    ...
    pub results: Vec<models::BuildLine>,
}

impl PaginatedBuildLineList {
    pub fn new(count: i32, results: Vec<models::BuildLine>) -> PaginatedBuildLineList {
