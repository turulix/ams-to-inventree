...
pub struct PaginatedNotificationMessageList {
    #[serde(rename = "count")]
    pub count: i32,
    ...
    pub results: Vec<models::NotificationMessage>,
}

impl PaginatedNotificationMessageList {
    pub fn new(count: i32, results: Vec<models::NotificationMessage>) -> PaginatedNotificationMessageList {
