...
pub struct PaginatedBarcodeScanResultList {
    #[serde(rename = "count")]
    pub count: i32,
    ...
    pub results: Vec<models::BarcodeScanResult>,
}

impl PaginatedBarcodeScanResultList {
    pub fn new(count: i32, results: Vec<models::BarcodeScanResult>) -> PaginatedBarcodeScanResultList {
