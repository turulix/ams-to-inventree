...
pub struct PaginatedReturnOrderList {
    #[serde(rename = "count")]
    pub count: i32,
    ...
    pub results: Vec<models::ReturnOrder>,
}

impl PaginatedReturnOrderList {
    pub fn new(count: i32, results: Vec<models::ReturnOrder>) -> PaginatedReturnOrderList {
