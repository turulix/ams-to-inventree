...
pub struct PaginatedSalesOrderShipmentList {
    #[serde(rename = "count")]
    pub count: i32,
    ...
    pub results: Vec<models::SalesOrderShipment>,
}

impl PaginatedSalesOrderShipmentList {
    pub fn new(count: i32, results: Vec<models::SalesOrderShipment>) -> PaginatedSalesOrderShipmentList {
