...
/// ExtendedUser : Serializer for a User with a bit more info.
...
impl ExtendedUser {
    ...
    pub fn new(pk: i32, username: String, first_name: String, last_name: String, email: String, groups: Vec<models::Group>, profile: models::BriefUserProfile) -> ExtendedUser {
        ExtendedUser {
            pk,
            username,
            first_name,
