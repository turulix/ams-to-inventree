...
pub struct PaginatedProjectCodeList {
    #[serde(rename = "count")]
    pub count: i32,
    ...
    pub results: Vec<models::ProjectCode>,
}

impl PaginatedProjectCodeList {
    pub fn new(count: i32, results: Vec<models::ProjectCode>) -> PaginatedProjectCodeList {
