...
pub struct PaginatedDataImportRowList {
    #[serde(rename = "count")]
    pub count: i32,
    ...
    pub results: Vec<models::DataImportRow>,
}

impl PaginatedDataImportRowList {
    pub fn new(count: i32, results: Vec<models::DataImportRow>) -> PaginatedDataImportRowList {
