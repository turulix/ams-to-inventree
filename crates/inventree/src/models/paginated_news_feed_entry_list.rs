...
pub struct PaginatedNewsFeedEntryList {
    #[serde(rename = "count")]
    pub count: i32,
    ...
    pub results: Vec<models::NewsFeedEntry>,
}

impl PaginatedNewsFeedEntryList {
    pub fn new(count: i32, results: Vec<models::NewsFeedEntry>) -> PaginatedNewsFeedEntryList {
