...
pub struct PaginatedRuleSetList {
    #[serde(rename = "count")]
    pub count: i32,
    ...
    pub results: Vec<models::RuleSet>,
}

impl PaginatedRuleSetList {
    pub fn new(count: i32, results: Vec<models::RuleSet>) -> PaginatedRuleSetList {
