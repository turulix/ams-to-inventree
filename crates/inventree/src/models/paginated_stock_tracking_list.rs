...
pub struct PaginatedStockTrackingList {
    #[serde(rename = "count")]
    pub count: i32,
    ...
    pub results: Vec<models::StockTracking>,
}

impl PaginatedStockTrackingList {
    pub fn new(count: i32, results: Vec<models::StockTracking>) -> PaginatedStockTrackingList {
