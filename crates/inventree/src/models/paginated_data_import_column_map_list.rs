...
pub struct PaginatedDataImportColumnMapList {
    #[serde(rename = "count")]
    pub count: i32,
    ...
    pub results: Vec<models::DataImportColumnMap>,
}

impl PaginatedDataImportColumnMapList {
    pub fn new(count: i32, results: Vec<models::DataImportColumnMap>) -> PaginatedDataImportColumnMapList {
