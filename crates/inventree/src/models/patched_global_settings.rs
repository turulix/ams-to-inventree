...
/// PatchedGlobalSettings : Serializer for the InvenTreeSetting model.
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct PatchedGlobalSettings {
...
impl PatchedGlobalSettings {
    /// Serializer for the InvenTreeSetting model.
    pub fn new() -> PatchedGlobalSettings {
