...
pub struct PaginatedNotesImageList {
    #[serde(rename = "count")]
    pub count: i32,
    ...
    pub results: Vec<models::NotesImage>,
}

impl PaginatedNotesImageList {
    pub fn new(count: i32, results: Vec<models::NotesImage>) -> PaginatedNotesImageList {
