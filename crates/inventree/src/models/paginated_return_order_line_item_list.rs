...
pub struct PaginatedReturnOrderLineItemList {
    #[serde(rename = "count")]
    pub count: i32,
    ...
    pub results: Vec<models::ReturnOrderLineItem>,
}

impl PaginatedReturnOrderLineItemList {
    pub fn new(count: i32, results: Vec<models::ReturnOrderLineItem>) -> PaginatedReturnOrderLineItemList {
