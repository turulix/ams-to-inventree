...
pub struct PaginatedParameterTemplateList {
    #[serde(rename = "count")]
    pub count: i32,
    ...
    pub results: Vec<models::ParameterTemplate>,
}

impl PaginatedParameterTemplateList {
    pub fn new(count: i32, results: Vec<models::ParameterTemplate>) -> PaginatedParameterTemplateList {
