...
pub struct PaginatedSalesOrderList {
    #[serde(rename = "count")]
    pub count: i32,
    ...
    pub results: Vec<models::SalesOrder>,
}

impl PaginatedSalesOrderList {
    pub fn new(count: i32, results: Vec<models::SalesOrder>) -> PaginatedSalesOrderList {
