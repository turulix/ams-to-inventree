...
pub struct PaginatedBomItemSubstituteList {
    #[serde(rename = "count")]
    pub count: i32,
    ...
    pub results: Vec<models::BomItemSubstitute>,
}

impl PaginatedBomItemSubstituteList {
    pub fn new(count: i32, results: Vec<models::BomItemSubstitute>) -> PaginatedBomItemSubstituteList {
