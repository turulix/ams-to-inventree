...
pub struct PaginatedIconPackageList {
    #[serde(rename = "count")]
    pub count: i32,
    ...
    pub results: Vec<models::IconPackage>,
}

impl PaginatedIconPackageList {
    pub fn new(count: i32, results: Vec<models::IconPackage>) -> PaginatedIconPackageList {
