...
pub struct PaginatedReportSnippetList {
    #[serde(rename = "count")]
    pub count: i32,
    ...
    pub results: Vec<models::ReportSnippet>,
}

impl PaginatedReportSnippetList {
    pub fn new(count: i32, results: Vec<models::ReportSnippet>) -> PaginatedReportSnippetList {
