...
pub struct PaginatedSalesOrderExtraLineList {
    #[serde(rename = "count")]
    pub count: i32,
    ...
    pub results: Vec<models::SalesOrderExtraLine>,
}

impl PaginatedSalesOrderExtraLineList {
    pub fn new(count: i32, results: Vec<models::SalesOrderExtraLine>) -> PaginatedSalesOrderExtraLineList {
