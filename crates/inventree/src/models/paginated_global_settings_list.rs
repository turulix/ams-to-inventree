...
pub struct PaginatedGlobalSettingsList {
    #[serde(rename = "count")]
    pub count: i32,
    ...
    pub results: Vec<models::GlobalSettings>,
}

impl PaginatedGlobalSettingsList {
    pub fn new(count: i32, results: Vec<models::GlobalSettings>) -> PaginatedGlobalSettingsList {
