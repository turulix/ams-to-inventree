...
pub struct PaginatedManufacturerPartList {
    #[serde(rename = "count")]
    pub count: i32,
    ...
    pub results: Vec<models::ManufacturerPart>,
}

impl PaginatedManufacturerPartList {
    pub fn new(count: i32, results: Vec<models::ManufacturerPart>) -> PaginatedManufacturerPartList {
