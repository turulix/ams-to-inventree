...
pub struct PaginatedUserCreateList {
    #[serde(rename = "count")]
    pub count: i32,
    ...
    pub results: Vec<models::UserCreate>,
}

impl PaginatedUserCreateList {
    pub fn new(count: i32, results: Vec<models::UserCreate>) -> PaginatedUserCreateList {
