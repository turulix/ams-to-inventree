...
/// UserSettings : Serializer for the InvenTreeUserSetting model.
...
impl UserSettings {
    ...
    pub fn new(pk: i32, key: String, value: Option<String>, name: String, description: String, user: i32, r#type: String, units: String, choices: Vec<serde_json::Value>, typ: String, confirm: bool, confirm_text: String) -> UserSettings {
        UserSettings {
            pk,
            key,
            value,
