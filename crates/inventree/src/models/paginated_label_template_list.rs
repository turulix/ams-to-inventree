...
pub struct PaginatedLabelTemplateList {
    #[serde(rename = "count")]
    pub count: i32,
    ...
    pub results: Vec<models::LabelTemplate>,
}

impl PaginatedLabelTemplateList {
    pub fn new(count: i32, results: Vec<models::LabelTemplate>) -> PaginatedLabelTemplateList {
