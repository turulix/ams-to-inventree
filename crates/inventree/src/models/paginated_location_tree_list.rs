...
pub struct PaginatedLocationTreeList {
    #[serde(rename = "count")]
    pub count: i32,
    ...
    pub results: Vec<models::LocationTree>,
}

impl PaginatedLocationTreeList {
    pub fn new(count: i32, results: Vec<models::LocationTree>) -> PaginatedLocationTreeList {
