...
pub struct PaginatedReportTemplateList {
    #[serde(rename = "count")]
    pub count: i32,
    ...
    pub results: Vec<models::ReportTemplate>,
}

impl PaginatedReportTemplateList {
    pub fn new(count: i32, results: Vec<models::ReportTemplate>) -> PaginatedReportTemplateList {
