...
pub struct PaginatedAttachmentList {
    #[serde(rename = "count")]
    pub count: i32,
    ...
    pub results: Vec<models::Attachment>,
}

impl PaginatedAttachmentList {
    pub fn new(count: i32, results: Vec<models::Attachment>) -> PaginatedAttachmentList {
