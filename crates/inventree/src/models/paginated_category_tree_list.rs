...
pub struct PaginatedCategoryTreeList {
    #[serde(rename = "count")]
    pub count: i32,
    ...
    pub results: Vec<models::CategoryTree>,
}

impl PaginatedCategoryTreeList {
    pub fn new(count: i32, results: Vec<models::CategoryTree>) -> PaginatedCategoryTreeList {
