...
pub struct PaginatedApiTokenList {
    #[serde(rename = "count")]
    pub count: i32,
    ...
    pub results: Vec<models::ApiToken>,
}

impl PaginatedApiTokenList {
    pub fn new(count: i32, results: Vec<models::ApiToken>) -> PaginatedApiTokenList {
