...
pub struct PaginatedSupplierPriceBreakList {
    #[serde(rename = "count")]
    pub count: i32,
    ...
    pub results: Vec<models::SupplierPriceBreak>,
}

impl PaginatedSupplierPriceBreakList {
    pub fn new(count: i32, results: Vec<models::SupplierPriceBreak>) -> PaginatedSupplierPriceBreakList {
