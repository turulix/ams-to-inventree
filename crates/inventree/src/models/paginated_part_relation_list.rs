...
pub struct PaginatedPartRelationList {
    #[serde(rename = "count")]
    pub count: i32,
    ...
    pub results: Vec<models::PartRelation>,
}

impl PaginatedPartRelationList {
    pub fn new(count: i32, results: Vec<models::PartRelation>) -> PaginatedPartRelationList {
