...
pub struct PaginatedStockLocationTypeList {
    #[serde(rename = "count")]
    pub count: i32,
    ...
    pub results: Vec<models::StockLocationType>,
}

impl PaginatedStockLocationTypeList {
    pub fn new(count: i32, results: Vec<models::StockLocationType>) -> PaginatedStockLocationTypeList {
