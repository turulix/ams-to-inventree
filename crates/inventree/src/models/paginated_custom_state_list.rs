...
pub struct PaginatedCustomStateList {
    #[serde(rename = "count")]
    pub count: i32,
    ...
    pub results: Vec<models::CustomState>,
}

impl PaginatedCustomStateList {
    pub fn new(count: i32, results: Vec<models::CustomState>) -> PaginatedCustomStateList {
