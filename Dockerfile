...
RUN cargo build --release --target ${RUST_TARGET} --package ams-to-inventree
...
COPY --from=backend_builder /app/target/${RUST_TARGET}/release/ams-to-inventree ./

ENTRYPOINT ["./ams-to-inventree"]